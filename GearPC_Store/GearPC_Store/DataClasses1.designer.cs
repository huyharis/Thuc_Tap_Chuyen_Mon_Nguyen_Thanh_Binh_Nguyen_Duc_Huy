...
namespace GearPC_Store
{
    ...
    partial void DeletenhomSP(nhomSP instance);
		...
		public DataClasses1DataContext() : 
				base(global::GearPC_Store.Properties.Settings.Default.DatabaseConnectionString, mappingSource)
		{
			OnCreated();
		}
    ...
    partial void OnthanhTienChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="sanPham_chiTietHDN1", Storage="_sanPham1", ThisKey="maSP", OtherKey="maSP", IsForeignKey=true)]
			...
			set
			{
							...
							|| (this._sanPham1.HasLoadedOrAssignedValue == false)))
				{
					...
					if ((previousValue != null))
					{
						...
						previousValue.chiTietHDNs1.Remove(this);
					}
					this._sanPham1.Entity = value;
					if ((value != null))
					{
						value.chiTietHDNs1.Add(this);
						this._maSP = value.maSP;
					}
					else
					{
	...
	public partial class sanPham : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntitySet<chiTietHDN> _chiTietHDNs1;
		
		private EntitySet<chiTietHDX> _chiTietHDXes;
		
		private EntitySet<chiTietHDX> _chiTietHDXes1;
		
		private EntitySet<chiTietSP> _chiTietSPs;
		
		private EntitySet<chiTietSP> _chiTietSPs1;
		
		private EntityRef<nhomSP> _nhomSP;
		
		private EntityRef<nhomSP> _nhomSP1;
    ...
    partial void OnphanLoaiChanged();
		...
		public sanPham()
		{
			...
			this._chiTietHDNs1 = new EntitySet<chiTietHDN>(new Action<chiTietHDN>(this.attach_chiTietHDNs1), new Action<chiTietHDN>(this.detach_chiTietHDNs1));
			...
			this._chiTietHDXes1 = new EntitySet<chiTietHDX>(new Action<chiTietHDX>(this.attach_chiTietHDXes1), new Action<chiTietHDX>(this.detach_chiTietHDXes1));
			...
			this._chiTietSPs1 = new EntitySet<chiTietSP>(new Action<chiTietSP>(this.attach_chiTietSPs1), new Action<chiTietSP>(this.detach_chiTietSPs1));
			this._nhomSP = default(EntityRef<nhomSP>);
			this._nhomSP1 = default(EntityRef<nhomSP>);
			OnCreated();
		}
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_phanLoai", DbType="NVarChar(50)")]
		public string phanLoai
		{
			...
			set
			{
				...
				{
					if ((this._nhomSP.HasLoadedOrAssignedValue || this._nhomSP1.HasLoadedOrAssignedValue))
					{
						throw new System.Data.Linq.ForeignKeyReferenceAlreadyHasValueException();
					}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="sanPham_chiTietHDN1", Storage="_chiTietHDNs1", ThisKey="maSP", OtherKey="maSP")]
		public EntitySet<chiTietHDN> chiTietHDNs1
		{
			get
			{
				return this._chiTietHDNs1;
			}
			set
			{
				this._chiTietHDNs1.Assign(value);
			}
		}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="sanPham_chiTietHDX1", Storage="_chiTietHDXes1", ThisKey="maSP", OtherKey="maSP")]
		public EntitySet<chiTietHDX> chiTietHDXes1
		{
			get
			{
				return this._chiTietHDXes1;
			}
			set
			{
				this._chiTietHDXes1.Assign(value);
			}
		}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="sanPham_chiTietSP1", Storage="_chiTietSPs1", ThisKey="maSP", OtherKey="maSP")]
		public EntitySet<chiTietSP> chiTietSPs1
		{
			get
			{
				return this._chiTietSPs1;
			}
			set
			{
				this._chiTietSPs1.Assign(value);
			}
		}
		
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="nhomSP_sanPham", Storage="_nhomSP", ThisKey="phanLoai", OtherKey="maLoai", IsForeignKey=true)]
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="nhomSP_sanPham1", Storage="_nhomSP1", ThisKey="phanLoai", OtherKey="maLoai", IsForeignKey=true)]
		public nhomSP nhomSP1
		{
			get
			{
				return this._nhomSP1.Entity;
			}
			set
			{
				nhomSP previousValue = this._nhomSP1.Entity;
				if (((previousValue != value) 
							|| (this._nhomSP1.HasLoadedOrAssignedValue == false)))
				{
					this.SendPropertyChanging();
					if ((previousValue != null))
					{
						this._nhomSP1.Entity = null;
						previousValue.sanPhams1.Remove(this);
					}
					this._nhomSP1.Entity = value;
					if ((value != null))
					{
					...
					this.SendPropertyChanged("nhomSP1");
				}
			}
		}
		...
		private void attach_chiTietHDNs1(chiTietHDN entity)
		{
			this.SendPropertyChanging();
			entity.sanPham1 = this;
		}
		
		private void detach_chiTietHDNs1(chiTietHDN entity)
		{
			this.SendPropertyChanging();
		...
		private void attach_chiTietHDXes1(chiTietHDX entity)
		{
			this.SendPropertyChanging();
			entity.sanPham1 = this;
		}
		
		private void detach_chiTietHDXes1(chiTietHDX entity)
		{
			this.SendPropertyChanging();
			entity.sanPham1 = null;
		}
		...
		private void attach_chiTietSPs1(chiTietSP entity)
		{
			this.SendPropertyChanging();
			entity.sanPham1 = this;
		}
		
		private void detach_chiTietSPs1(chiTietSP entity)
		{
			this.SendPropertyChanging();
			entity.sanPham1 = null;
		}
    ...
    partial void OnthanhTienChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="sanPham_chiTietHDX1", Storage="_sanPham1", ThisKey="maSP", OtherKey="maSP", IsForeignKey=true)]
		public sanPham sanPham1
		{
			get
			{
			...
			set
			{
							...
							|| (this._sanPham1.HasLoadedOrAssignedValue == false)))
				{
					...
					{
						this._sanPham1.Entity = null;
						previousValue.chiTietHDXes1.Remove(this);
					}
					this._sanPham1.Entity = value;
					if ((value != null))
					{
						value.chiTietHDXes1.Add(this);
						this._maSP = value.maSP;
					}
					else
					{
    ...
    partial void OncolorChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="sanPham_chiTietSP1", Storage="_sanPham1", ThisKey="maSP", OtherKey="maSP", IsForeignKey=true)]
		public sanPham sanPham1
		{
			get
			{
			...
			set
			{
							...
							|| (this._sanPham1.HasLoadedOrAssignedValue == false)))
				{
					...
					{
						this._sanPham1.Entity = null;
						previousValue.chiTietSPs1.Remove(this);
					}
					this._sanPham1.Entity = value;
					if ((value != null))
					{
						value.chiTietSPs1.Add(this);
						this._maSP = value.maSP;
					}
					else
					{
    ...
    partial void OnbacLuongChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="congViec_nhanVien", Storage="_nhanViens", ThisKey="maCV", OtherKey="congViec")]
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="congViec_nhanVien1", Storage="_nhanViens1", ThisKey="maCV", OtherKey="congViec")]
    ...
    partial void OncongViecChanged();
		...
		public string congViec
		{
			...
			set
			{
				...
				{
					if ((this._congViec1.HasLoadedOrAssignedValue || this._congViec2.HasLoadedOrAssignedValue))
					{
						throw new System.Data.Linq.ForeignKeyReferenceAlreadyHasValueException();
					}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="congViec_nhanVien", Storage="_congViec1", ThisKey="congViec", OtherKey="maCV", IsForeignKey=true)]
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="congViec_nhanVien1", Storage="_congViec2", ThisKey="congViec", OtherKey="maCV", IsForeignKey=true)]
    ...
    partial void OntenLoaiChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="nhomSP_sanPham", Storage="_sanPhams", ThisKey="maLoai", OtherKey="phanLoai")]
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="nhomSP_sanPham1", Storage="_sanPhams1", ThisKey="maLoai", OtherKey="phanLoai")]
